...
type CatalogServiceVersion struct {
	...
	// The version name of the whole service. Is usually the version of the main container
	Name string `bson:"name" json:"name"`
...
// It contains every technical information needed to create and start the container
