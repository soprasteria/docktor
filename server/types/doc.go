...
These entities are structures persisted to database and exposed within a REST-like API.
...
A user is someone who is registered and authorized to use Docktor. The person can either be administrator or simple user. An administrator is able to do and see everything. Rights of simple user are defined in groups to which they belong to.
